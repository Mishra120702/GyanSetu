...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (isset($_POST['update_progress'])) {
        ...
        logSystemActivity($db, $_SESSION['user_id'], 'TOPIC_COMPLETED', "Student updated subtopic progress (ID: $sub_topic_id) to Theory: $theory_completed, Practical: $practical_completed.");
    ...
    elseif (isset($_POST['edit_sub_topic'])) {
        ...
        logSystemActivity($db, $_SESSION['user_id'], 'TOPIC_COMPLETED', "Student updated subtopic (ID: $sub_topic_id, Name: '$sub_topic_name') to Theory: $theory_completed, Practical: $practical_completed.");
...
$main_topics_stmt = $db->prepare("
    SELECT mt.*, c.name as course_name 
    FROM main_topics mt 
