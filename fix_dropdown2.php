...
$new_select = "<select id=\"course_filter\" onchange=\"window.location.assign('view_attendance.php?batch_id=<?= urlencode(\$selected_batch_id) ?>&amp;course_id=' + this.value)\" class=\"px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500\">";
