...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --danger-color: #c0392b;
            --warning-color: #b6876a;
            --success-color: #2d7a8a;
            --info-color: #456882;
        ...
        header.bg-white {
            ...
            border-bottom: 1px solid rgba(27, 60, 83, 0.10) !important;
            box-shadow: 0 4px 20px rgba(27, 60, 83, 0.05) !important;
            backdrop-filter: blur(8px) !important;
        }
        ...
        /* Brand metric card gradients */
        .mc-red     { background: linear-gradient(135deg,#c0392b 0%,#922b21 100%) !important; box-shadow: 0 8px 24px rgba(192,57,43,0.30); color: white !important; }
        .mc-teal    { background: linear-gradient(135deg,#2d7a8a 0%,#1B3C53 100%) !important; box-shadow: 0 8px 24px rgba(45,122,138,0.30); color: white !important; }
        .mc-orange  { background: linear-gradient(135deg,#b6876a 0%,#9c6f55 100%) !important; box-shadow: 0 8px 24px rgba(182,135,106,0.30); color: white !important; }
        .mc-slate   { background: linear-gradient(135deg,#3a6278 0%,#1B3C53 100%) !important; box-shadow: 0 8px 24px rgba(58,98,120,0.30); color: white !important; }
        
        .mc-red:hover     { transform: translateY(-5px) scale(1.02); box-shadow: 0 20px 40px rgba(192,57,43,0.45); }
        .mc-teal:hover    { transform: translateY(-5px) scale(1.02); box-shadow: 0 20px 40px rgba(45,122,138,0.45); }
        .mc-orange:hover  { transform: translateY(-5px) scale(1.02); box-shadow: 0 20px 40px rgba(182,135,106,0.45); }
        .mc-slate:hover   { transform: translateY(-5px) scale(1.02); box-shadow: 0 20px 40px rgba(58,98,120,0.45); }

        .mc-red p, .mc-red h3, .mc-red span, .mc-red i,
        .mc-teal p, .mc-teal h3, .mc-teal span, .mc-teal i,
        .mc-orange p, .mc-orange h3, .mc-orange span, .mc-orange i,
        .mc-slate p, .mc-slate h3, .mc-slate span, .mc-slate i {
            color: white !important;
        }
        
        .mc-red .progress-bar, .mc-teal .progress-bar, .mc-orange .progress-bar, .mc-slate .progress-bar {
            background: rgba(255, 255, 255, 0.25) !important;
        }
        
        .mc-red .progress-fill, .mc-teal .progress-fill, .mc-orange .progress-fill, .mc-slate .progress-fill {
            background: white !important;
        }
        
        .mc-red .bg-gradient-to-br, .mc-teal .bg-gradient-to-br, .mc-orange .bg-gradient-to-br, .mc-slate .bg-gradient-to-br {
            background: rgba(255, 255, 255, 0.2) !important;
            box-shadow: none !important;
        }

        /* Override Tailwind gradients with Brand color gradients */
        ...
        .bg-gradient-to-r.from-purple-500.to-purple-600 {
            background: linear-gradient(135deg, #3a6278 0%, #1B3C53 100%) !important;
        }
        ...
        .from-blue-100.to-blue-200 {
            background: linear-gradient(135deg, #A4C4D4 0%, #D2C1B6 100%) !important;
        }
        .text-blue-600 {
        ...
        thead.bg-gray-50, thead {
            background: rgba(27,60,83,0.07) !important;
        }
        th {
            color: #1B3C53 !important;
        ...
        .bg-purple-100 {
            background-color: rgba(69, 104, 130, 0.15) !important;
        }
        .text-purple-700 {
            color: #234C6A !important;
        }
        ...
        .timeline-item .bg-gradient-to-r.from-gray-50.to-white {
        ...
        .badge-admin {
            background: linear-gradient(135deg, #e8eff3 0%, #cbdde7 100%) !important;
            color: #234C6A !important;
            border: 1px solid #cbdde7 !important;
        }
        
        .badge-mentor {
            background: linear-gradient(135deg, #edf1f4 0%, #cbd7df 100%) !important;
            color: #456882 !important;
            border: 1px solid #cbd7df !important;
        }
        
        .badge-student {
            background: linear-gradient(135deg, #f7f5f3 0%, #e9e3de 100%) !important;
...
<body class="bg-gray-50">
    ...
    <div class="flex-1 ml-0 md:ml-64 min-h-screen">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="glass-card stat-card p-6 cursor-pointer mc-red" onclick="filterByStatus(1)" style="animation-delay: 0.1s">
            ...
            <div class="glass-card stat-card p-6 cursor-pointer mc-teal" onclick="filterByStatus(0)" style="animation-delay: 0.2s">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="glass-card stat-card p-6 mc-orange" style="animation-delay: 0.3s">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="glass-card stat-card p-6 cursor-pointer mc-slate" onclick="resetFilters()" style="animation-delay: 0.4s">
                <div class="flex items-center justify-between">
                    <div>
