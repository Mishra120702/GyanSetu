...
<nav class="md:hidden fixed top-0 left-0 right-0 bg-gradient-to-r from-indigo-600 to-purple-600 text-white z-50 shadow-lg">
    <div class="flex items-center justify-between px-4 py-3">
        ...
        <!-- Mobile Menu Button -->
        <button id="mobileMenuButton" class="text-white text-2xl hover:text-gray-200 transition-colors duration-300">
...
// Mobile sidebar toggle (for desktop sidebar on mobile)
