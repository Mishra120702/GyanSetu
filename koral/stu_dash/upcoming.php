...
<div class="flex-1 ml-0 md:ml-64 min-h-screen transition-all duration-300 ease-in-out">
    ...
    <div class="p-4 md:p-6 bg-gray-50 min-h-screen">
        ...
        <div class="mb-6 glass-card p-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="?batch_index=all&month=<?= $current_month ?>&year=<?= $current_year ?>" 
                   class="px-4 py-2 rounded-lg transition-all duration-300 <?= (isset($_GET['batch_index']) && $_GET['batch_index'] == 'all') ? 'bg-purple-600 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' ?>">
                    <div class="flex items-center">
        ...
        <?php if (isset($_GET['batch_index']) && $_GET['batch_index'] == 'all'): ?>
            ...
            <div class="bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-xl shadow-lg p-4 md:p-6 mb-6 fade-in">
        ...
        <?php elseif($selected_batch): ?>
            <!-- Single Batch Header -->
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl shadow-lg p-4 md:p-6 mb-6 fade-in">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
