            ...
            <form method="POST" id="bulkActionForm" class="bg-white shadow-md rounded-lg mb-6 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row md:items-end md:justify-between space-y-4 md:space-y-0">
                        ...
                        <div id="transferFields" class="hidden flex-1 md:mr-4">
                            ...
                            <select id="target_batch" name="target_batch" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                ...
                                <?php foreach ($available_batches as $batch_option): ?>
                                    <option value="<?= htmlspecialchars($batch_option['batch_id']) ?>" 
                                            data-available="<?= $batch_option['available_seats'] ?>">
                                        <?= htmlspecialchars($batch_option['batch_name']) ?> 
                                        (<?= $batch_option['current_enrollment'] ?>/<?= $batch_option['max_students'] ?> - 
                                        <?= $batch_option['available_seats'] ?> seats available)
                                    </option>
                                <?php endforeach; ?>
                            </select>
                                    ...
                                    <tr class="table-row-hover">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <div class="flex space-x-2">
                                                <a href="student_view.php?id=<?= htmlspecialchars($student['student_id']) ?>" 
                                                ...
                                                <?php if ($student['current_status'] === 'active'): ?>
                                                    <a href="javascript:void(0)" 
                                                       onclick="transferSingleStudent('<?= htmlspecialchars($student['student_id']) ?>', '<?= htmlspecialchars($student['first_name'] . ' ' . $student['last_name']) ?>')"
